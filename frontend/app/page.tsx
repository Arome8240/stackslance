      ...
      <section className="bg-primary text-primary-foreground">
        <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col items-center text-center gap-6">
          ...
          <div className="flex w-full max-w-xl rounded-xl overflow-hidden border-2 border-primary-foreground/30 shadow-lg">
            ...
            />
            <button className="bg-background hover:bg-accent text-primary font-bold px-6 text-sm transition-colors">
              Search
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex gap-2 overflow-x-auto">
          {CATEGORIES.map((c) => (
            <Badge
              key={c.label}
              variant="outline"
              className="whitespace-nowrap cursor-pointer hover:border-primary hover:text-primary hover:bg-primary/5 transition-colors px-4 py-2 text-sm gap-1.5"
            >
              {c.icon} {c.label}
            </Badge>
          ))}
